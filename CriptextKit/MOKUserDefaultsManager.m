...
@implementation MOKUserDefaultsManager
static MOKUserDefaultsManager *userDefaultsManagerInstance = nil;
+ (MOKUserDefaultsManager*)instance {
	@synchronized (self) {
		if (userDefaultsManagerInstance == nil) {
			userDefaultsManagerInstance = [[MOKUserDefaultsManager alloc] init];
		}
	}
